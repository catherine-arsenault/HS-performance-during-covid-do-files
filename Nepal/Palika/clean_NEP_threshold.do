...
use "$user/$data/Data for analysis/Nepal_palika_Jan19-Dec20_WIDE_CCA_AN.dta", clear
	...
	foreach x in  fp_sa_util fp_la_util anc_util del_util cs_util pnc_util diarr_util pneum_util totaldel ///
			   ...
			   sb_mort_num mat_mort_num ipd_mort_num neo_mort_num  {
				...
				drop _merge
				save "$user/$data/Data for analysis/Nepal_palika_Jan19-Dec20_WIDE_CCA_DB`m'.dta", replace
		}
	foreach x of global all {
