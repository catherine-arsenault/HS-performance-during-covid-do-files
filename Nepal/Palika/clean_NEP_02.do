...
global all fp_util anc_util del_util cs_util pnc_util diarr_util pneum_util sam_util opd_util ipd_util er_util live_births tbdetect_qual hivdiag_qual pent_qual bcg_qual measles_qual opv3_qual pneum_qual rota_qual sb_mort mat_mort ipd_mort 

/****************************************************************
VOLUMES:  REPLACE MISSINGS TO 0 IF MISSINGNESS IS CONSISTENT
****************************************************************
Identifies consistent missingnes in volume data. If the palika is missing data at the begining 
and then starts reporting until the end , we will assume that a one time swtich from missing to non-missing 
indicates a new palika opening (or that newly starts reporting a certain indicator)
