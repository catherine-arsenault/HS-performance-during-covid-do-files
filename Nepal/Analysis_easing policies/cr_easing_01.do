...
replace mo = 7 if month =="7_20"
replace mo = 8 if month =="8_20"
replace mo = 9 if month =="9_20"
replace mo = 10 if month =="10_20"
replace mo = 11 if month =="11_20"
replace mo = 12 if month =="12_20"
drop month
...
* For now, dropped the pre-lockdown period
...
order org* year month post eased_ eased_cat

lab var post "Pre/post period for simple DD analysis"
lab var eased_ "Treated/control: eased covid-19 policies"
