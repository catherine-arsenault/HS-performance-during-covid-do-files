...
* Average number of new COVID cases per palika per month
summtab, contvars(covid_case)  by(eased_fixed)  mean directory("$user/$analysis") excel excelname(Table1) sheetname(avgcovid_byeased) replace title(Table1)
