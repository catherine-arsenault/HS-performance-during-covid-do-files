...
table region year if month>=4 & month<=6 , c(sum anc_util)
table region year if month>=4 & month<=6 , c(sum diarr_util)
table region year if month>=4 & month<=6 , c(sum pneum_util)
table region year if month>=4 & month<=6 , c(sum pent_qual)
