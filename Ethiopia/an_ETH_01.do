...
global vax vacc_qual pent_qual bcg_qual measles_qual opv3_qual pneum_qual rota_qual  
global mortality newborn_mort_num sb_mort_num mat_mort_num totaldel er_mort_num totalipd_mort


tabstat $rmnch if month>=1 & month<= 3 & year==2020, s(N sum) c(s)  format(%20.10f)
tabstat $rmnch if month>=4 & month<= 6 & year==2020, s(N sum) c(s)  format(%20.10f)
