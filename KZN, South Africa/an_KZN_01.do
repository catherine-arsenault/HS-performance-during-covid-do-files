...
*1)RMNCH 
by year, sort: tabstat  anc1_util del_util cs_util pnc_util diarr_util pneum_util sam_util if month>=4 & month<= 7, s(N sum) c(s)  format(%20.10f)

*2) Vaccine 
by year, sort: tabstat  vacc_qual pent_qual bcg_qual measles_qual pneum_qual rota_qual if month>=4 & month<= 7, s(N sum) c(s)  format(%20.10f)


*3) Other volumes 
by year, sort: tabstat  art_util opd_util ipd_util road_util diab_util trauma_util icu_util if month>=4 & month<= 7, s(N sum) c(s)  format(%20.10f)


*4) Quality 
by year, sort: tabstat  kmcn_qual cerv_qual tbscreen_qual tbdetect_qual tbtreat_qual  if month>=4 & month<= 7, s(N sum) c(s)  format(%20.10f)



*5) Institutional Mortality 

by year, sort: tabstat  newborn_mort_num sb_mort_num mat_mort_num ipd_mort_num icu_mort_num trauma_mort_num if month>=4 & month<= 7, s(N sum) c(s) 

by year, sort: tabstat  totaldel  ipd_util icu_util trauma_util if month>=4 & month<= 7, s(N sum) c(s) 
