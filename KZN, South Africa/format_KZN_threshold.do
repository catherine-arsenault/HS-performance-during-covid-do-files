...
u "$user/$data/Data for analysis/KZN_Jan19-Dec20_WIDE_CCA_DB`m'.dta", clear
...
preserve
	...
	putexcel set "$user/$data/Codebook for South Africa.xlsx", sheet(T`m')  modify
...
putexcel set "$user/$data/Codebook for South Africa.xlsx", sheet(Final data `m')  modify
putexcel A2 = "Variable"
...
save "$user/$data/Data for analysis/KZN_su_24months`m'.dta", replace 
}
