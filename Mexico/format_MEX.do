...
use "$user/$data/Data for analysis/IMSS_Jan19-Nov20_WIDE.dta", clear
...
save "$user/$data/Data for analysis/IMSS_Jan19-Nov20_foranalysis.dta", replace
********************************************************************************
...
export delimited using "$user/$data/IMSS_Jan19-Nov20_fordashboard.csv", replace
