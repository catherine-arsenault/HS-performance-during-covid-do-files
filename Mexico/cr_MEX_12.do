...
* March 16, 2021
* Mexico - IMSS, December 2020 indicators

clear all
set more off	

// Sent by Svetlana Mar 3, 2021
import spss using "$user/$data/Raw/Indicadores_IMSS_December2020.sav", clear
...
********************************************************************************
merge 1:1 Delegation using "$user/$data/Data for analysis/IMSS_Jan19-Nov20_WIDE.dta"
drop _merge 

save "$user/$data/Data for analysis/IMSS_Jan19-Dec20v1_WIDE.dta", replace
