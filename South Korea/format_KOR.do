...
*****************************************************************/
u "$user/$data/Data for analysis/Kor_Jan19-Oct20_WIDE_CCA_AN.dta", clear
...
reshape long sti_util anc_util del_util cs_util diarr_util pneum_util diab_util hyper_util art_util mental_util opd_util er_util ipd_util kmc_qual newborn_mort_num sb_mort_num mat_mort_num allcause_mort_num ipd_mort_num totaldel, i(region) j(month) string 
