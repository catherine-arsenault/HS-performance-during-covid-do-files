...
* Outpatient
			...
			graphregion(color(white)) title("Thailand outpatient visits (2019-2020)", size(msmall) color(black)) ///
			xlabel(1(1)24) xlabel(, labsize(msmall)) ylabel(0(100000)500000, labsize(msmall))
			
			graph export "$analysis/Results/Graphs/Fig1/THA_opd_util.pdf", replace	
* Deliveries
	u "$user/$THAdata/Data for analysis/THAtmp.dta", clear
