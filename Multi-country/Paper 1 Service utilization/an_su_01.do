...
foreach c in CHL ETH GHA HTI KZN LAO MEX NEP KOR THA {
	...
	putexcel set "$analysis/Results/Tables/Results by country sep15.xlsx", sheet("`c'")  modify
...
foreach c in CHL ETH GHA HTI KZN LAO MEX NEP KOR THA {
	...
	putexcel set "$analysis/Results/Tables/Relative % drop by country sep15.xlsx", sheet("`c'")  modify
...
foreach c in CHL ETH GHA HTI KZN LAO MEX NEP KOR THA {
	...
	u "$user/$`c'data/Data for analysis/`c'tmp.dta", clear
	putexcel set "$analysis/Results/Tables/Relative % resumption sep15.xlsx", sheet("`c'")  modify
