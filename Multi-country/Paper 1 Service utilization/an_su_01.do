...
foreach c in CHL ETH GHA HTI KZN LAO MEX NEP KOR THA {
	...
	putexcel set "$analysis/Results/Tables/Results by country SEP29.xlsx", sheet("`c'")  modify
...
foreach c in CHL ETH GHA HTI KZN LAO MEX NEP KOR THA {
	...
	putexcel set "$analysis/Results/Tables/Relative % drop by country SEP29.xlsx", sheet("`c'")  modify
...
foreach c in CHL ETH GHA HTI KZN LAO MEX NEP KOR THA {
	...
	u "$user/$`c'data/Data for analysis/`c'tmp.dta", clear
	putexcel set "$analysis/Results/Tables/Relative % resumption SEP29.xlsx", sheet("`c'")  modify
...
* 	Heatmap
********************************************************************************
	import excel using "$analysis/Results/Tables/Relative % resumption SEP29.xlsx", sheet(CHL) firstrow clear
	save "$analysis/Results/Tables/tmp.dta", replace
	foreach c in  ETH GHA HTI KZN LAO MEX NEP KOR THA {
		import excel using "$analysis/Results/Tables/Relative % resumption SEP29.xlsx", sheet(`c') firstrow clear
		append using "$analysis/Results/Tables/tmp.dta"
		save "$analysis/Results/Tables/tmp.dta", replace
	}
	rename F country
