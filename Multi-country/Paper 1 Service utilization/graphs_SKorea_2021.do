...
* OPD			
			...
			xlabel(1(1)29) xlabel(, labels valuelabels labsize(tiny)) ylabel(0(1000000)4500000, labsize(vsmall))
...
* IPD			
			...
			ylabel(, labsize(small)) xline(15, lpattern(dash) lcolor(black)) ///
			 xline(21, lpattern(dash) lcolor(gs10))  /// 
			xtitle("", size(small)) legend(off) ///
			graphregion(color(white)) title(" South Korea inpatient admissions (January 2019 - May 2021)", size(small)) ///
			xlabel(1(1)29) xlabel(, labels valuelabels labsize(tiny))  ylabel(0(20000)100000, labsize(vsmall))
...
* Deliveries			
			...
			ylabel(, labsize(small)) xline(15, lpattern(dash) lcolor(black)) ///
			 xline(21, lpattern(dash) lcolor(gs10))  ///
			xtitle("", size(small)) legend(off) ///
			graphregion(color(white)) title("South Korea facility based deliveries (January 2019 - May 2021)", size(small)) ///
			xlabel(1(1)29) xlabel(, labels valuelabels labsize(tiny)) ylabel(0(400)2000, labsize(small))
			
			graph export "$analysis/Results/Graphs/2021/KOR_totaldel.pdf", replace			
...
* Diabetes
			...
			ylabel(, labsize(small)) xline(15, lpattern(dash) lcolor(black)) ///
			 xline(21, lpattern(dash) lcolor(gs10)) ///
			xtitle("", size(small)) legend(off) ///
			graphregion(color(white)) title("South Korea diabetes visits (January 2019 - May 2021)", size(small)) ///
			xlabel(1(1)29) xlabel(, labels valuelabels labsize(tiny)) ylabel(0(25000)225000, labsize(vsmall))
