...
* OPD
			...
			xlabel(1(1)30) xlabel(, labels valuelabels labsize(vsmall)) ylabel(0(5000)35000, labsize(vsmall))
...
* Deliveries
			...
			xlabel(1(1)30) xlabel(, labels valuelabels labsize(tiny)) ylabel(0(50)650, labsize(vsmall))
