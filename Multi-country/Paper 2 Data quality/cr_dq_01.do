...
preserve 
	...
	reshape long opd_util anc_util totaldel pnc_util pent_qual vacc_qual flag_outlier_opd_util ///
...
reshape long opd_util anc_util totaldel pnc_util pent_qual vacc_qual, ///
...
* Use dataset before cleaning
* Haiti
global sentinel opd_util anc_util totaldel pnc_util vacc_qual diab_util
